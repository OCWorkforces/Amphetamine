...
export async function checkNotificationPermission(): Promise<void> {
  ...
  const { response } = await dialog.showMessageBox({
    ...
    message: "Amphetamine needs notification permission to remind you about meetings.",
    detail:
      "Would you like to open System Settings to enable notifications for Amphetamine?",
  });
